...
export class ReassignTaskDto {
  @ApiProperty({
    ...
    description: 'ID thành viên mới được giao công việc',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'Thời gian dự kiến bắt đầu làm công việc sau khi giao lại',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Thời gian dự kiến kết thúc hoặc hạn hoàn thành sau khi giao lại',
  })
  @IsOptional()
