...
export class AiChatService {
  ...
  private async buildSystemPrompt(
    ...
    return [
      ...
      '- Khi hỏi/lập kế hoạch ai góp bao nhiêu cho mục tiêu tài chính, phải dùng get_goal_contribution_suggestions. Chỉ nêu thu nhập/chi tiêu/khả dụng của từng thành viên nếu số đó có trong kết quả tool; nếu thiếu dữ liệu hoặc bị ẩn quyền xem thì nói rõ thiếu dữ liệu, không tự chia đều hoặc tự bịa số.',
      ...
      '- Với FAMILY_MANAGER hoặc DEPUTY_MEMBER, khi người dùng hỏi danh sách thu/chi/thực tế tài chính của từng thành viên, dùng list_member_monthly_finances. Nếu tool trả member nhưng một số field null do visibility riêng tư hoặc chưa khai báo, hãy nói đúng lý do đó; không trả lời chung chung là không có quyền.',
